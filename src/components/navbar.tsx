				...
				<div className="flex items-center justify-between h-14 md:h-16">
					...
					<Link href="/" className="flex items-center gap-3 group ml-4">
						<span
							...
							style={{
								marginLeft: 20,
								fontFamily: '"Courier New", Impact, system-ui, sans-serif',
							}}
						>
							GrowOrbit
						</span>
					...
					<div className="hidden lg:flex items-center gap-4">
						<Show when="signed-out">
							<SignInButton mode="modal">
								<ModernButton type="button" size="sm">Sign In</ModernButton>
							</SignInButton>
						</Show>
						<Show when="signed-in">
							<UserButton />
			...
			>
				<div className="px-6 py-8 space-y-6">
					...
					<div className="pt-4 border-t border-white/10">
						<Show when="signed-out">
							<SignInButton mode="modal">
								<ModernButton type="button" size="sm" style={{ width: "100%" }}>
									Sign In
								</ModernButton>
							</SignInButton>
						</Show>
